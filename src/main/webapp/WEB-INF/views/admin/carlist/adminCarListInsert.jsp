...
<div>
	...
	<div class="table-responsive">
		<form id="listInsert" name="listInsert">
			<table border="1" class="table table-bordered">
				<tr>
					<td>차량명</td>
					<td><input type="text" name="car_name" id="car_name" required>(원)</td>
				</tr>
				<tr>
					<td>대여가격</td>
				...
				<tr>
					...
					<td><select name="car_number_passengers"
						id="car_number_passengers" required>
				...
				<tr>
					...
					<td><input type="text" name="car_adv_insurance"
						id="car_adv_insurance" required>(원)</td>
				</tr>
				<tr>
					<td>차량 옵션</td>
					<td><input type="checkbox" name="car_option" id="car_option"
						...
						id="car_option" value="블랙박스">블랙 박스</td>
				</tr>
				<tr>
					<td>이미지 업로드</td>
